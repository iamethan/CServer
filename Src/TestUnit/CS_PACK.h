...
const unsigned char g_uPackHeadSize = 4;
    ...
    // 坐标信息包 请求
class CTransformPack_REQ: public BasePacket
{
public:
    // 包体
	struct CPackBody
    ...
    // 坐标信息包 广播
class CTransformPack_NTF: public BasePacket
{
public:
    // 包体
	struct CPackBody
    ...
    // 行为动作请求包
class CTransformEndPack_REQ: public BasePacket
{
public:
    // 包体
	struct CPackBody
    ...
    // 复活请求包
class CReCreate_REQ: public BasePacket
{
public:
    // 包体
	struct CPackBody
    ...
    // 行为动作请求包
class CActionPack_REQ: public BasePacket
{
public:
    // 包体
	struct CPackBody
    ...
    // 行为动作包 是否成功  发送给自己
class CActionPack_REV: public BasePacket
{
public:
    // 包体
	struct CPackBody
    ...
    // 行为动作包（更新状态、血、蓝等） 广播
class CStatusPack_NTF: public BasePacket
{
public:
    // 包体
	struct CPackBody
    ...
    // 技能释放请求包
class CSkillPack_REQ: public BasePacket
{
public:
    // 包体
	struct CPackBody
    ...
    // 技能释放 （判断是否释放成功）发给自己
class CSkillPack_REV: public BasePacket
{
public:
    // 包体
	struct CPackBody
    ...
    // 技能释放 （释放成功时）广播
class CSkillPack_NTF: public BasePacket
{
public:
    // 包体
	struct CPackBody
    ...
    // 技能释放结束 状态  广播
class CSkillStatus_NTF: public BasePacket
{
public:
    // 包体
	struct CPackBody
    ...
    // 解除 玩家buff 广播
class CRelieveBuff_NTF: public BasePacket
{
public:
    // 包体
	struct CPackBody
    ...
    // 创建他人
class CCreatePlayer_NTF: public BasePacket
{
public:
    // 包体
	struct CPackBody
    ...
    // 创建自己
class CCreatePlayer_REV: public BasePacket
{
public:
    // 包体
	struct CPackBody
    ...
    // 删除玩家
class CRemovePlayer_NTF: public BasePacket
{
public:
    // 包体
	struct CPackBody
